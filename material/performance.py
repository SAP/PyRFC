...
'''
    ...
    for _ in range(10):
        ...
        # print sys.getsizeof(result['ETAB0332'][0]) / 1024, sys.getsizeof(result['ETAB0332']) / 1024, sys.getsizeof(result['ETAB0332'][0]) * COUNT / 1024,  sys.getsizeof(result['ETAB0332'][0]) * COUNT - sys.getsizeof(result['ETAB0332'])
'''
