...
def process_docstring(app, what, name, obj, options, lines):
    ...
    if name == "pyrfc.Connection.rstrip":
        lines.append(
            u"If True, returned strings from :meth:`~Connection.call` are right stripped."
        )
        lines.append(u"For details see :ref:`client-connectionconfig-rstrip`.")
    elif name == "pyrfc.Connection.config.return_import_params":
        lines.append(
            u"If True, :meth:`~Connection.call` also returns parameters of type IMPORT."
        )
        lines.append(
...
latex_documents = [
    ("index", "pyrfc-%s.tex" % release, u"pyrfc Documentation", u"SAP", "manual")
]
...
man_pages = [("index", "pyrfc", u"pyrfc Documentation", [u"SAP"], 1)]
